...
import functional_waveforms, analysis, save2013style, TTL, LabView, DDS, roi_fitting, picomotors, andor, picam, DCNoiseEater, Laird_temperature, AnalogInput, instek_pst, unlock_pause
...
class AQuA(Experiment):
    ...
    def __init__(self):
        ...
        self.analyses += [self.TTL_filters, self.AI_graph, self.AI_filter, self.squareROIAnalysis, self.gaussian_roi,
                          ...
                          self.save2013Analysis, self.instekpsts, self.unlock_pause]
