...
class ProxyField(ProxyControl):
    ...
    #MTL: a method to manually control the red validation box
...
class Field(Control):
    ...
    #MTL create an attribute to manually specify if text is valid
    valid = d_(Bool())
    ...
    # Observers
    #--------------------------------------------------------------------------
    #MTL: added 'valid' to list of observed things
    @observe('text', 'mask', 'submit_triggers', 'placeholder', 'echo_mode',
        'max_length', 'read_only', 'valid')
