...
## Initilization
    ...
    exp.mot_3d_y_shutter_switch.profile(t_y_shutter_open+extension,'off')
 ...
 # for specific purposes
   ...
   ##Microwave(t_science,t_microwave) # Microwave for Ryd780B
    ...
    #Ryd780A_pulsed(t_science+extension, 0.01, 'r2', 'r2', 0.0008, 50)
    ...
    t_readout_3rd=t_start_blue_imaging+extension
