...
## Initilization
    ...
    exp.ryd780a_aom_switch.profile(0,'on') # for Matt's ARL, on
    exp.ryd780a_dds.profile(0,'r2')  # for Matt's ARL, r2
    exp.red_pointing_dds.profile(0,'off')# for Matt's ARL, on.
    ...
    exp.ground_aom_switch.profile(170+4,'on')
...
#    exp.ground_aom_switch.profile(155,'off')
    ...
    AO(0,0,coil_driver_polarity*I_Q1)
    AO(0,1,coil_driver_polarity*I_Q2)
    AO(0,2,coil_driver_polarity*I_test_X) #X
    AO(0,3,coil_driver_polarity*I_test_Y) #Y
    AO(0,4,coil_driver_polarity*I_test_Z) #Z
    AO(0,5,coil_driver_polarity*-2.2)
    AO(0,6,coil_driver_polarity*2.8)
    AO(0,7,10)
    ...
    AO(200,2,coil_driver_polarity*I_test_X) #X
    AO(200,3,coil_driver_polarity*I_test_Y) #Y
    AO(200,4,coil_driver_polarity*I_test_Z) #Z
