...
## Initilization
    ...
    exp.hf_aom_switch.profile(t_start,'on')
    exp.hf_aom_switch.profile(t_end+0.2,'off') ###
    exp.fort_dds.profile(t_end+0.2,'science')
    ...
    #
    exp.mot_3d_x_shutter_switch.profile(t_x_shutter_open+50,'off')
    exp.mot_3d_x_shutter_switch.profile(t_x_shutter_close+50,'on')
    exp.mot_3d_y_shutter_switch.profile(t_y_shutter_open+50,'off')
    exp.mot_3d_y_shutter_switch.profile(t_y_shutter_close+50,'on')
    exp.mot_3d_z1_shutter_switch.profile(t_z1_shutter_open+50,'off')
    exp.mot_3d_z1_shutter_switch.profile(t_z1_shutter_close+50,'on')

    ## Science Phase 170 - 175 ms. t_science=170

    # reduce FORT trap depth during science phase
    t_science2 = t_science+50
    ...
    exp.red_pointing_dds.profile(175+50,'off')
    exp.red_pointing_aom_switch.profile(175+50,'off')

    ## Blow-away Phase 176ms

    AO(175+50,0,coil_driver_polarity*-0.1)
    AO(175+50,1,coil_driver_polarity*0.1)
    AO(175+50,2, coil_driver_polarity*shimX_BA) #X
    AO(175+50,3,coil_driver_polarity*shimY_BA) #Y
    AO(175+50,4,coil_driver_polarity*shimZ_BA) #Z
    ...
    ## Readout Phase
    AO(180+50,0,0) # turn off quadrupole fields
    AO(180+50,1,0)
    AO(180+50,2, coil_driver_polarity*shimX_RO) #X
    AO(180+50,3, coil_driver_polarity*shimY_RO) #Y
    AO(180+50,4, coil_driver_polarity*shimZ_RO) #Z
    t_readout_2nd=195+50
