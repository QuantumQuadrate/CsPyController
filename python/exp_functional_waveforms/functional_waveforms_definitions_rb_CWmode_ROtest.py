...
## Initilization
   ...
   #  exp.fort_dds.profile(t_end,'on')
    ...
    ## Readout Phase
    AO(140+t_readoutduration+1+t_gap,0,0) # turn off quadrupole fields
    AO(140+t_readoutduration+1+t_gap,1,0)
    AO(140+t_readoutduration+1+t_gap,2, coil_driver_polarity*shimX_RO) #X
    AO(140+t_readoutduration+1+t_gap,3, coil_driver_polarity*shimY_RO) #Y
    AO(140+t_readoutduration+1+t_gap,4, coil_driver_polarity*shimZ_RO) #Z
    t_readout_2nd=140+t_readoutduration+1+t_gap+3
