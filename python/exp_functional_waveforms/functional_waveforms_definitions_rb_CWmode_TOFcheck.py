...
## Initilization
    ...
    AO(t_2DMOT_loading+3,0,0) # turns off quadrupole fields
    AO(t_2DMOT_loading+3,1,0)
    ...
    AO(t_2DMOT_loading+3,2,coil_driver_polarity*FOshimx) #X
    AO(t_2DMOT_loading+3,3,coil_driver_polarity*FOshimy) #Y
    AO(t_2DMOT_loading+3,4,FOshimz) #Z
