...
## Initilization
    ...
    AO(t_2DMOT_loading,2,coil_driver_polarity*FOshimx) #X
    AO(t_2DMOT_loading,3,coil_driver_polarity*FOshimy) #Y
    AO(t_2DMOT_loading,4,FOshimz) #Z
    exp.mot_aom_switch.profile(t_2DMOT_loading,'off')
    #exp.fort_dds.profile(111,'on')
    exp.hf_aom_switch.profile(t_2DMOT_loading,'off') #####
    AO(t_2DMOT_loading,7,0)


#PGC
    t_start=t_2DMOT_loading+1
