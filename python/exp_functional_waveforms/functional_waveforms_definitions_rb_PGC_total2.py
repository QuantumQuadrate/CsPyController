...
def readout(t,duration):
    ...
    phases = [[0.18, 0.49],[0.69, 0.91]] # wide Best so far
...
## Initilization
    ...
    exp.fort_dds.profile(140,'low')
    t_start=140
    t_leadtime=0
    t_LAS_leadtime=0
    exp.mot_3d_dds.profile(t_start+t_LAS_leadtime,'PGC')
 ...
 # for specific purposes
   ...
   ##Microwave(t_science,t_microwave) # Microwave for Ryd780B
    ...
    AO(180+extension,2, coil_driver_polarity*shimX_PGC) #X
    AO(180+extension,3, coil_driver_polarity*shimY_PGC) #Y
    AO(180+extension,4, coil_driver_polarity*shimZ_PGC) #Z
