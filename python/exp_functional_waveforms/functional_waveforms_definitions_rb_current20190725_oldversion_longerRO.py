...
def readout(t,duration):
    ...
    phases = [[0.26, 0.48], [0.59, 0.9]] # wide Best so far, as of June-ish 2019
...
## Initilization
    ...
    exp.camera.pulse_length=t_readoutduration # Changes HSDIO pulse width to control exposure
 ...
 # for specific purposes
   ...
   ##Microwave(t_science,t_microwave) # Microwave for Ryd780B
    ...
    exp.camera.pulse_length=t_readoutduration
    exp.camera.take_shot(t_start)
