...
exp.op_aom_switch.profile(160,'on')
exp.op_dds.profile(162,'off')
exp.op_aom_switch.profile(162,'off')
exp.hf_aom_switch.profile(160,'on')
exp.hf_aom_switch.profile(162.5,'off')
...
exp.microwave_dds.profile(170.2,'off')
exp.microwave_switch.profile(170.2,'off')
