# This file has been updated by MTL to add the on_action_invalid and
# on_action_valid methods.  This file will need to replace 
# C:\Users\Saffmanlab\AppData\Local\Enthought\Canopy\User\Lib\site-packages\enaml\qt\qt_field.py
...
class QtField(QtControl):
    ...
    def on_text_edited(self):
        ...
        #MTL: commented out (client-side) validate-as-you-type behavior
        #widget = self.widget()
    ...
    def set_text(self, text):
        ...
        self._last_value = text
        #MTL: Do not clear error style, only do that when valid is changed
        #self._clear_error_style()
    ...
    def on_action_invalid(self, content):
        """ Make the box red.

        """
        self._set_error_style()

    def on_action_valid(self, content):
        """ Make the box not-red.
