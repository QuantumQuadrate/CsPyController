def script(n, delay_before_excitation_pulse, microwave_pi_by_2, clock_rate):
...
'''
    ...
    delay = int((delays[n][0]*delay_before_excitation_pulse + delays[n][1]*microwave_pi_by_2) * clock_rate/1000)
